...
const suncity = ({ navigation}) => {
  return (
    <View style={styles.container}>
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        <View style={styles.houseContainer}>
          <Image
            source={require('../assets/twobed1.jpeg')} // Replace with the path to your image
            style={styles.image}
          />
        ...
        <View style={styles.houseContainer}>
          <Image
            source={require('../assets/twobed2.jpeg')} // Replace with the path to your image
            style={styles.image}
          />
        ...
        <View style={styles.houseContainer}>
          <Image
            source={require('../assets/twobed3.jpeg')} // Replace with the path to your image
            style={styles.image}
          />
        ...
        <View style={styles.houseContainer}>
          <Image
            source={require('../assets/twoBedroomWash.jpeg')} // Replace with the path to your image
            style={styles.image}
          />
