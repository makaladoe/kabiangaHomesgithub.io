  ...
  return (
    <View style={styles.container}>
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        ...
        <View style={styles.houseContainer}>
          <Image
            source={require('../assets/self2.jpeg')} // Replace with the path to your image
            style={styles.image}
          />
        ...
        <View style={styles.houseContainer}>
          <Image
            source={require('../assets/self3.jpeg')} // Replace with the path to your image
            style={styles.image}
          />
        ...
        <View style={styles.houseContainer}>
          <Image
            source={require('../assets/selfContainedWash.jpeg')} // Replace with the path to your image
            style={styles.image}
          />
